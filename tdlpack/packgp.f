...
C
 ...
 420  CONTINUE
C
CD     WRITE(KFILDO,421)(JMIN(K),K=1,LX)
CD421  FORMAT(' JMIN( ) IN PACKGP'/(10I12))
CD     WRITE(KFILDO,422)(JMAX(K),K=1,LX)
CD422  FORMAT(' JMAX( ) IN PACKGP'/(10I12))
CD     WRITE(KFILDO,423)(LBIT(K),K=1,LX)
CD423  FORMAT(' LBIT( ) IN PACKGP'/(10I12))
CD     WRITE(KFILDO,424)(NOV(K),K=1,LX)
CD424  FORMAT(' NOV( ) IN PACKGP'/(10I12))

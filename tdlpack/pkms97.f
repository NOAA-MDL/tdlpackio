...
C
CD    WRITE(KFILDO,115)(IS1(J),J=9,12),(IS1(J),J=3,7),
CD   1                 (IS1(J),J=23,22+IS1(22))
CD115 FORMAT(' ****ALL VALUES IN FIELD '1XI9.9,1XI9.9,1XI9.9,1XI10.3,
CD   1       ' FOR DATE ',I5,2I2.2,1X2I2.2,'Z ARE MISSING IN PKMS97'/
CD   2       ' '24X,32R1)
C       

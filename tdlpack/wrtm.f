      SUBROUTINE WRTM(KFILDO,KFILX,ID,RECORD,NSIZE,
     1                NREPLA,NCHECK,KEYREC,LSTRD,
     2                NOPREC,MASTER,NW,IER) 
C 
...
C                                   LOCATION OF LAST KEY RECORD BELOW 153
C        
C        PURPOSE 
C            TO WRITE A DATA RECORD TO THE MOS-2000 EXTERNAL DIRECT ACCESS
C            FILE SYSTEM.  KEY RECORDS ARE READ/WRITTEN AS NECESSARY. 
C            CALLED BY WRTDLM.  MOST 2-DIMENSIONED VARIABLES IN WRTDLM ARE 
...
C            RDKEYM, WRKEYM, WRDATM  
C 
      DIMENSION ID(4),RECORD(NSIZE) 
...
C        REPLACMENT TO BE DONE AND NO MATCH FOUND.  ERROR INDICATED.
 ...
 146  FORMAT(/,' ****REPLACING RECORD WITH ID =',1X,I9.9,2I10.9,I11.3,
     1         ' IN WRTM ON UNIT NO.',I3,' BUT RECORD NOT FOUND.',/,
...
C        IN THE LOGICAL RECORD.
      CALL WRDATM(KFILDO,KFILX,KEYREC(6,NREC),RECORD,NSIZE,
     1            MASTER(3),'WRWRD1',IER) 
...
C 
 ...
 171  FORMAT(/,' ****NOT REPLACING RECORD, BUT DUPLICATE FOUND',
     1         ' IN WRTM ON UNIT NO.',I3,', ID =',1X,I9.9,
     2         2I10.9,I11.3)
      IER=157 
      GO TO 900 
C
...
CD1750 FORMAT(/' WRTM AT 175, KEYREC(5,L),MASTER(3),NSIZE,NOW,NEED',5I6)
...
C
 ...
 176  FORMAT(/,' ****REPLACING RECORD WITH ID =',1X,I9.9,2I10.9,I11.3,
     1         ' IN WRTM ON UNIT NO.',I3,' BUT NOT ENOUGH ROOM IN OLD',
...
C        NOPREC(4) SET TO INDICATE KEY RECORD MAY HAVE BEEN CHANGED. 
      CALL WRDATM(KFILDO,KFILX,KEYREC(6,L),RECORD,NSIZE,
     1            MASTER(3),'WRWRD2',IER) 

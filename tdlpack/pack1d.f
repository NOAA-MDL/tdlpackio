...
C
CD     CALL TIMPR(KFILDO,KFILDO,'START PACK1D        ')
C
...
CD     WRITE(KFILDO,117)(IS0(J),J=1,8)
CD117  FORMAT(/,' PACK1D, IS0( )',/,(O12,7I12))
CD     WRITE(KFILDO,118)(IS1(J),J=1,IS1(1))
CD118  FORMAT(/,' PACK1D, IS1( )',/,(10I12))
CD     WRITE(KFILDO,120)(IS4(J),J=1,21)
CD120  FORMAT(/,' PACK1D, IS4( )',/,(10I12))
CD     CALL TIMPR(KFILDO,KFILDO,'END PACK1D          ') 
      RETURN
      END

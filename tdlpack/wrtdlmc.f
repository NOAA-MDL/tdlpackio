      SUBROUTINE WRTDLMC(KFILDO,KFILX,CFILX,ID,RECORD,NSIZE,
     1                   NREPLA,NCHECK,L3264B,IER) 
C 
C       SEPTEMBER 2012   ENGLE   MDL MOS-2000, ADAPTED FROM WRTDLM;
C                                RECORD( ) IS NOW DEFINED AS A
C                                CHARACTER(LEN=L3264B/8) FOR THE PURPOSE
C                                OF READING STATION CALL LETTERS FROM
...
C
      CALL WRTMC(KFILDO,KFILX,ID,RECORD,NSIZE,

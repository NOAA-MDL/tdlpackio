...
C
 150  IF(L3264B.EQ.32)THEN
      ...
      ENDIF
C
CD     WRITE(KFILDO,158)NWORDS,NTOTBY,NTOTRC
CD158  FORMAT(/' WRITING DATA IN WRITEP'/
CD    1        '    NWORDS ='I10  '   WORDS WRITTEN'/
CD    2        '    NTOTBY ='I10  '   TOTAL BYTES IN FILE'/
CD    4        '    NTOTRC ='I10  '   TOTAL RECORDS IN FILE')
      GO TO 200
C
